...
I did not add every recent securitization or heterogeneous-beliefs paper. For example, I did not add Malamud's moral-hazard securitization paper because it is less directly tied to the paper's main heterogeneous-beliefs and waterfall-tranching results.
