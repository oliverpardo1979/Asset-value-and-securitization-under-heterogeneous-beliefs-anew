...
The same numerical example illustrates the return effect discussed in Section \ref{sec:ep}. Writing $\underline{\Delta}$ for the benchmark excess return and $\Delta$ for the securitized case, and using $P=Q_{\mathcal{B}}$, theory $\mathcal{B}$'s actual and perceived expectations coincide, so $\underline{\Delta}_{\mathcal{B}}=\Delta_{\mathcal{B}}=0$. In contrast, theory $\mathcal{A}$ receives a negative excess return. In the benchmark,
\[
\underline{\Delta}_{\mathcal{A}}
=\frac{1}{3}(1-2)+\frac{1}{3}(2-2)
=-\frac{1}{3}.
\]
With ABS, the senior payoff vector is $\left(\frac{21}{20},\frac{9}{4},\frac{9}{4}\right)$ and the junior payoff vector is $\left(0,0,\frac{3}{4}\right)$. Hence, $\mathcal{A}$'s perceived payoffs are $\frac{37}{20}$ for the senior tranche and $\frac{1}{4}$ for the junior tranche. Since $\mathcal{A}$ buys both tranches in state $l$ and the junior tranche in state $m$,
\[
\Delta_{\mathcal{A}}
...
=-\frac{13}{30}.
\]
Thus, in this example, securitization makes theory $\mathcal{A}$'s excess return lower by $\frac{1}{10}$ without increasing theory $\mathcal{B}$'s excess return.
